...
async def get_camera_for_date_page(
    ...
    return templates.TemplateResponse(
        ...
        context={
            ...
            "location": location,
            "camera": camera.model_dump(),
            "channelData": data.channel_data if is_historical else None,
            "perDay": data.per_day if is_historical else None,
            "metadata": data.metadata if is_historical else None,
